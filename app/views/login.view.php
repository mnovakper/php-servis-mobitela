...
<main class="form-signin w-100 m-auto">
    <form method="post">
        <img class="mb-4" src="<?=ROOT?>/assets/img/agramservis.png" alt="">
        ...
        <div class="form-floating">
            <input name="username" value="<?=old_value('username')?>" class="form-control" id="floatingInput" placeholder="name@example.com">
